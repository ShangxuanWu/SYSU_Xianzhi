...
<div class="header">
    <a class="logo-home" href="index.html"><img src="images/logo_su.jpg" alt="img" width="40"></a>
...
if(!$result)//开始判断是够为空  
    {  
    echo "<br><font color='red'>这几天我们没有收到更多的闲置了！</font><br><br>";
...
<?php
    ...
    {
        echo "<br><font color = 'blue'>这几天我们没有收到更多闲置了！</font>";
    }
?>
                      <p align="center">  
                          ...
                          <?php if($page !=1)
 {
    echo '<a href="http://1.sysuxianzhi.sinaapp.com/view_today_sell_su.php?page=';
    echo $page-1;
...
<div class="footer">
    <div class="small-navigation-icons">
        ...
        <a href="upload_sell_su.php" class="small-nav-icon upload-nav"></a>
        <div class="clear"></div>
    </div>
