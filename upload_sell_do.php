...
$sql2= "insert into test (time,name,price,description,contact,location,type,photo) values (now(),'$name','$price','$description','$phone','$location','$type','$filename')";
